...
static void MX_ADC1_Init(void)
{
  ...
  PB1   ------> ADC1_IN12
  */
  GPIO_InitStruct.Pin = OPA1_O_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(OPA1_O_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = OPA3_O_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(OPA3_O_GPIO_Port, &GPIO_InitStruct);
...
static void MX_ADC2_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Pin = OPA2_O_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(OPA2_O_GPIO_Port, &GPIO_InitStruct);
